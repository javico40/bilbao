...
/**
 * Vprofile generated by hbm2java
 */
public class Vprofile  implements java.io.Serializable {
    ...
    public Vprofile(String name, Set<Trainer> trainers) {
       this.name = name;
       this.trainers = trainers;
    }
   
    public Integer getIdvprofile() {
        return this.idvprofile;
    }
