...
@Scope("singleton")
@Service("CitiesLogic")
public class CitiesLogic implements ICitiesLogic {
    private static final Logger log = LoggerFactory.getLogger(CitiesLogic.class);

    /**
     * DAO injected by Spring that manages Cities entities
     *
     */
    @Autowired
    ...
    */
    ...
    public void saveCities(Cities entity) throws Exception {
        ...
        try {
            if ((entity.getCitiesName() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getCitiesName(), 100) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "citiesName");
            }

            if (getCities(entity.getIdcities()) != null) {
    ...
    public void deleteCities(Cities entity) throws Exception {
        ...
        if (entity.getIdcities() == null) {
            throw new ZMessManager().new EmptyFieldException("idcities");
        }

        List<Users> userses = null;

        try {
            userses = usersDAO.findByProperty("cities.idcities",
                    entity.getIdcities());
    ...
    public void updateCities(Cities entity) throws Exception {
        ...
        try {
            ...
            log.error("update Cities failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public List<CitiesDTO> getDataCities() throws Exception {
        try {
            List<Cities> cities = citiesDAO.findAll();
            ...
            for (Cities citiesTmp : cities) {
                ...
                citiesDTO2.setIdcities(citiesTmp.getIdcities());
                citiesDTO2.setCitiesName((citiesTmp.getCitiesName() != null)
                    ? citiesTmp.getCitiesName() : null);
                citiesDTO.add(citiesDTO2);
            }
    ...
    public Cities getCities(Integer idcities) throws Exception {
        ...
        try {
            entity = citiesDAO.findById(idcities);
        } catch (Exception e) {
            log.error("get Cities failed", e);
            throw new ZMessManager().new FindingException("Cities");
        } finally {
        }
    ...
    public List<Cities> findPageCities(String sortColumnName,
        ...
        throws Exception {
        List<Cities> entity = null;

        try {
            entity = citiesDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Cities Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Cities> findByCriteria(Object[] variables,
        ...
        try {
            list = citiesDAO.findByCriteria(where);
        } catch (Exception e) {
