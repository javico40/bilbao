...
public class CategoryLogic implements ICategoryLogic {
    private static final Logger log = LoggerFactory.getLogger(CategoryLogic.class);
    ...
    */
    ...
    public List<Category> getCategory() throws Exception {
        ...
        try {
            ...
            log.error("finding all Category failed", e);
    ...
    public void saveCategory(Category entity) throws Exception {
        ...
        try {
            if (entity.getLevel() == null) {
                throw new ZMessManager().new ForeignException("level");
            }
            ...
            if (entity.getLevel().getIdlevel() == null) {
                throw new ZMessManager().new EmptyFieldException(
                    "idlevel_Level");
            }

            if (getCategory(entity.getIdcategory()) != null) {
                throw new ZMessManager(ZMessManager.ENTITY_WITHSAMEKEY);
            }

            categoryDAO.save(entity);

            log.debug("save Category successful");
        } catch (Exception e) {
            log.error("save Category failed", e);
            throw e;
        } finally {
        }
    }
    ...
    public void deleteCategory(Category entity) throws Exception {
        ...
        if (entity == null) {
            throw new ZMessManager().new NullEntityExcepcion("Category");
        }
    ...
    public void updateCategory(Category entity) throws Exception {
        log.debug("updating Category instance");
    ...
    public List<CategoryDTO> getDataCategory() throws Exception {
        try {
            ...
            for (Category categoryTmp : category) {
                CategoryDTO categoryDTO2 = new CategoryDTO();

                categoryDTO2.setIdcategory(categoryTmp.getIdcategory());
                categoryDTO2.setDescription((categoryTmp.getDescription() != null)
                    ? categoryTmp.getDescription() : null);
                categoryDTO2.setIdlevel_Level((categoryTmp.getLevel()
                                                          .getIdlevel() != null)
                    ? categoryTmp.getLevel().getIdlevel() : null);
                categoryDTO.add(categoryDTO2);
            }
    ...
    public Category getCategory(Integer idcategory) throws Exception {
        log.debug("getting Category instance");

        Category entity = null;

        try {
            entity = categoryDAO.findById(idcategory);
        } catch (Exception e) {
            log.error("get Category failed", e);
            throw new ZMessManager().new FindingException("Category");
        } finally {
        }
    ...
    public List<Category> findPageCategory(String sortColumnName,
        ...
        try {
            entity = categoryDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Category Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Category> findByCriteria(Object[] variables,
        ...
        try {
            list = categoryDAO.findByCriteria(where);
        } catch (Exception e) {
