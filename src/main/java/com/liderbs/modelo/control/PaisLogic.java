...
public class PaisLogic implements IPaisLogic {
    ...
    */
    ...
    public void savePais(Pais entity) throws Exception {
        ...
        try {
            if ((entity.getPaisnombre() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getPaisnombre(), 250) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "paisnombre");
            }

            if (getPais(entity.getIdpais()) != null) {
    ...
    public void deletePais(Pais entity) throws Exception {
        ...
        if (entity.getIdpais() == null) {
            throw new ZMessManager().new EmptyFieldException("idpais");
        }

        List<Estado> estados = null;

        try {
            estados = estadoDAO.findByProperty("pais.idpais", entity.getIdpais());
    ...
    public List<PaisDTO> getDataPais() throws Exception {
        try {
            ...
            for (Pais paisTmp : pais) {
                ...
                paisDTO2.setIdpais(paisTmp.getIdpais());
                paisDTO2.setPaisnombre((paisTmp.getPaisnombre() != null)
                    ? paisTmp.getPaisnombre() : null);
    ...
    public Pais getPais(Integer idpais) throws Exception {
        ...
        try {
            entity = paisDAO.findById(idpais);
        } catch (Exception e) {
