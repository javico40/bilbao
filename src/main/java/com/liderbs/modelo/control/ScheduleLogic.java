...
*/
@Scope("singleton")
@Service("ScheduleLogic")
public class ScheduleLogic implements IScheduleLogic {
    private static final Logger log = LoggerFactory.getLogger(ScheduleLogic.class);
    ...
    */
    ...
    public List<Schedule> getSchedule() throws Exception {
        ...
        try {
            ...
            log.error("finding all Schedule failed", e);
    ...
    public void saveSchedule(Schedule entity) throws Exception {
        ...
        try {
            ...
            log.debug("save Schedule successful");
        } catch (Exception e) {
    ...
    public void deleteSchedule(Schedule entity) throws Exception {
        ...
        if (entity.getIdschedule() == null) {
            throw new ZMessManager().new EmptyFieldException("idschedule");
        }

        try {
            scheduleDAO.delete(entity);

            log.debug("delete Schedule successful");
        } catch (Exception e) {
    ...
    public void updateSchedule(Schedule entity) throws Exception {
        ...
        try {
            ...
            log.debug("update Schedule successful");
        } catch (Exception e) {
    ...
    public List<ScheduleDTO> getDataSchedule() throws Exception {
        try {
            ...
            for (Schedule scheduleTmp : schedule) {
    ...
    public Schedule getSchedule(Integer idschedule) throws Exception {
        log.debug("getting Schedule instance");

        Schedule entity = null;

        try {
            entity = scheduleDAO.findById(idschedule);
        } catch (Exception e) {
            log.error("get Schedule failed", e);
            throw new ZMessManager().new FindingException("Schedule");
        } finally {
        }
    ...
    public List<Schedule> findPageSchedule(String sortColumnName,
        ...
        throws Exception {
        List<Schedule> entity = null;

        try {
            entity = scheduleDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("Schedule Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<Schedule> findByCriteria(Object[] variables,
        ...
        try {
            list = scheduleDAO.findByCriteria(where);
        } catch (Exception e) {
