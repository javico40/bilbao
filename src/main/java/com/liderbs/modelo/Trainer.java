...
public class Trainer  implements java.io.Serializable {
    ...
    public Trainer(Vprofile vprofile, Academiclevel academiclevel, Identification identification, Integer usersIdusers) {
    ...
    public void setVprofile(Vprofile vprofile) {
        this.vprofile = vprofile;
    }
